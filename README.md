...
| Modular Neural Network (MNN) | Sequence-to-sequence learning (Seq2Seq) is the process of developing models that transform sequences from one domain to another using data from other domains. This may be used for machine translation or for question answering without the need for a computer. As a general principle, it may be used whenever you need to create text. There are a variety of approaches that may be used to do this job, including RNNs and 1D convnets. | [Get better understanding on MNN](https://www3.cs.stonybrook.edu/~cse634/L12ModularNN.pdf) |

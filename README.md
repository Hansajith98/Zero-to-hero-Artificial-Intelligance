...
Note: This post assumes you're familiar with the fundamentals of deep learning and have developed RNN models. You can start with these articles if you need a refresher:. | [Essentials of Deep Learning – Sequence to Sequence modelling with Attention (using python)](https://www.analyticsvidhya.com/blog/2018/03/essentials-of-deep-learning-sequence-to-sequence-modelling-with-attention-part-i/) |
## Neural Networks
